            ...
            <AuthLayout>
                <div className="content-wrapper">
                    ...
                    <Modal show={showContinue} onHide={handleCloseContinue} id="generat-story">
                        ...
                        <Modal.Body>
                            <h5 className="text-center mb-3">When do you want to publish this story?</h5>
                            <div className="input-container" >
                                ...
                                <input type="text" placeholder="Select Date" className="input_field  form-control"
                                    id="password_field" style={{
                                        background: "#0B1024", borderRadius: "50px", width: "690px",

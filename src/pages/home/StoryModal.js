        ...
        <Modal show={show} onHide={handleClose} id="generat-story">
             <div className="step1to4">
                ...
                <Modal.Body>
                    ...
                    <div className="story-step-form" id="step2" style={{display: "none"}} >
                        <div className="body-popup-title">
                        <h3>Select Age</h3>
                        </div>
                        <div className="button-list-form">
                    ...
                    <div className="story-step-form" id="step3"  style={{display: "none"}}>
                        <div className="body-popup-title">
                        <h3>Select Genre </h3>
                        </div>
                        <div className="button-list-form">
                    ...
                    <div className="story-step-form" id="step4" style={{display: "none"}} >
                        <div className="body-popup-title">
                        <h3>Enter Prompt</h3>
                        </div>
                        <div className="button-list-form">
             ...
             <div className="succes" id="successpopup" style={{display: "none"}} >
                <Modal.Body>
